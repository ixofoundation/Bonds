...
import (
	...
	"github.com/cosmos/hackatom/x/nameservice"
...
func NewNameServiceApp(logger tlog.Logger, db dbm.DB) *nameServiceApp {
	...
	var app = &nameServiceApp{
		...
		keyPricing:       sdk.NewKVStoreKey(pricing.StoreKey),
	...
	app.pricingKeeper = pricing.NewKeeper(
		app.bankKeeper,
		app.keyPricing,
		app.cdc,
	)
	...
	app.mm = sdk.NewModuleManager(
		...
		pricing.NewAppModule(app.pricingKeeper, app.bankKeeper),
